      ...
      <section className="padding-top padding-bottom bg--dark">
        <div className="container">
          ...
          <div className="text-white mt-5" style={{ maxWidth: "800px", margin: "0 auto" }}>
            ...
            <ul>
              <li> Project Introduction & Vision</li>
              <li> Token Utility and Use Cases</li>
              <li> Emission, Treasury, and Mining Model</li>
              <li> Roadmap & Partnerships</li>
              <li> Off-Chain Venture Buffer</li>
              <li> Hashrate-Backed Token Framework</li>
            </ul>
